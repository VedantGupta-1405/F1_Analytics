...
export function Navbar() {
  ...
  useEffect(() => {
    if (searchQuery.length > 1) {
      axios.get(`https://f1-analytics-r1v0.onrender.com/api/search?q=${searchQuery}&year=${season}`)
  ...
  return (
    <nav className={cn(
      ...
      scrolled ? "bg-[#0d0d0d] border-[#262626] py-4" : "bg-[#0d0d0d]/90 backdrop-blur border-transparent py-6"
    )}>
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="relative hidden lg:block" ref={searchRef}>
              ...
              {searchOpen && searchQuery.length > 1 && (
                <div className="absolute top-full right-0 mt-2 w-full bg-[#151515] border-2 border-[#262626] shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-1 z-50">
